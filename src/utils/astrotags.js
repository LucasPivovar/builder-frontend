/**
 * Helper para substituição dinâmica de Astrotags e Formatações Inline no Astro Builder
 */
...
export function parseAstrotags(text, altColor = '#f1c232', bgColor = '#00ff0b', options = {}) {
  if (!text) return '';
  ...
  // 2. Astrotags de variáveis dinâmicas
...
export const parseAtomitags = parseAstrotags;
