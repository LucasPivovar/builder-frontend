...
export function generateFullHTML(stateOrRows, pageSettingsParam) {
  ...
  const quizCardBg = /^#[0-9a-f]{6}$/i.test(pageSettings.quizCardBg || '') ? pageSettings.quizCardBg : '#ffffff';
  const quizOptionBg = /^#[0-9a-f]{6}$/i.test(pageSettings.quizOptionBg || '') ? pageSettings.quizOptionBg : '#ffffff';
  const quizOptionBorder = /^#[0-9a-f]{6}$/i.test(pageSettings.quizOptionBorder || '') ? pageSettings.quizOptionBorder : '#bae6fd';
  const quizAccent = /^#[0-9a-f]{6}$/i.test(pageSettings.quizAccent || '') ? pageSettings.quizAccent : '#0ea5e9';
